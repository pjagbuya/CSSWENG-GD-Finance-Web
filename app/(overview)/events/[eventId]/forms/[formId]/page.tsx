  ...
  if (aiData) {
    ...
    return (
      <>
        ...
        <br />
        <div className="form-info">
          <div className="form-info-title">Notes:</div>
          <div className="form-info-description">
            {notes}
            <underline />
          </div>
...
const FormViewPage = async ({ params: { formId } }: FormViewPageProps) => {
  ...
  return (
    <div className="form">
      ...
      <line />
      <div className="form-main">{bodyComponent!}</div>
      <line />
